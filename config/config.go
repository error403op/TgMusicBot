...
func LoadConfig() error {
	...
	Conf = &BotConfig{
		...
		DbName:            getEnvStr("DB_NAME", "queen"),
		...
		SupportGroup:      getEnvStr("SUPPORT_GROUP", "https://t.me/Itz_venom_family"),
		SupportChannel:    getEnvStr("SUPPORT_CHANNEL", "https://t.me/tomatofist"),
